...
```
curl -O https://raw.githubusercontent.com/gregpalmr/dcos-workshop-2019-03-19/master/clusters/setup/dashboard-ext.yaml
```
...
![k8s-sign-in](https://github.com/gregpalmr/dcos-workshop-2019-03-19/blob/master/screenshots/k8s-sign-in.png)

Congratulations! You should now see the Kubernetes dashboard.

![k8s-dashboard](https://github.com/gregpalmr/dcos-workshop-2019-03-19/blob/master/screenshots/k8s-dashboard.png)


[Next Lab >>](https://github.com/gregpalmr/dcos-workshop-2019-03-19/blob/master/labs/1%20-%20Kubernetes-labs/Lab_02a_Launch_a_second_Kubernetes_Cluster.md)
